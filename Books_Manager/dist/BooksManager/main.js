...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.EorrorHandler = function (error) {
        ...
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_0__["throwError"])('try again');
    };
    ;
    ApiService.prototype.extractedData = function (res) {
        var body = res;
        return body || {};
    };
    ApiService.prototype.getBooks = function () {
        return this.http.get(apiUrl, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(this.extractedData), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.EorrorHandler));
    };
    return ApiService;
}());
...
module.exports = "<a routerLink='/books'>Books</a>\r\n<router-outlet></router-outlet>\r\n"
...
/* harmony import */ var _book_edit_book_edit_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./book-edit/book-edit.component */ "./src/app/book-edit/book-edit.component.ts");
...
var bookRoutes = [
    {
        path: 'books',
        component: _book_book_component__WEBPACK_IMPORTED_MODULE_10__["BookComponent"],
        data: { title: 'bookList' }
    },
    {
    ...
    {
        path: 'books-create',
        component: _book_create_book_create_component__WEBPACK_IMPORTED_MODULE_12__["BookCreateComponent"],
        data: { title: 'book Create' }
    },
    {
        path: 'books-edit/:id',
        component: _book_edit_book_edit_component__WEBPACK_IMPORTED_MODULE_13__["BookEditComponent"],
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _book_create_book_create_component__WEBPACK_IMPORTED_MODULE_12__["BookCreateComponent"],
                _book_edit_book_edit_component__WEBPACK_IMPORTED_MODULE_13__["BookEditComponent"]
            ],
            imports: [
                _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot(bookRoutes),
...
module.exports = "<p>this is book component</p>"
...
var BookComponent = /** @class */ (function () {
    ...
    BookComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.api.getBooks().subscribe(function (res) {
            console.log(res);
            _this.books = res;
        }, function (err) {
            console.log(err);
...
module.exports = __webpack_require__(/*! C:\Users\priya\Desktop\task1\Angular_Application\BooksManager\src\main.ts */"./src/main.ts");
